...
function themify_theme_design_controls( $data = array() ) {
	...
	$html .= '<div class="group-hide" data-hide="none header-leftpane header-minbar boxed-content">';
		...
		$html .= sprintf('<p class="hide-if none header-horizontal header-leftpane header-minbar boxed-layout boxed-content header-top-bar pushlabel"><label for="%1$s"><input type="checkbox" id="%1$s" name="%1$s" %2$s value="yes"/> %3$s</label>
			<br><small>%4$s</small>
			</p>',
			$key,
